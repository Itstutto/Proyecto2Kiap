...
public:
        ...
        virtual Movimiento* crearMovimiento(const string& name, double danio, double impacto, string info, string extremidad, string zonaImpacto, double difficulty, int costo) = 0;
};
