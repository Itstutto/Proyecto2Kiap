...
public:
        ...
        virtual Movimiento* crearMovimiento(const string& nombre, double danio, double impacto, string info, string extremidad, string zonaImpacto, double dificultad, int costo) = 0;
};
