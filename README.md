# Archivo README
    ...
    En este documento en formato Readme, se brindará una breve explicación del proyecto y su simulación,
...
Para iniciar la simulación se le brinda una bienvenida y además una lista de opciones en donde se puede
escoger entre iniciar el combate, cambiarle el nombre, el género por defecto al personaje principal o 
reiniciar las estadísticas.

Al iniciar el combate, se brinda la información del round y el porcentaje de vida del jugador,
